...
HPDI(logistic(post$a + post$b2) -logistic(post$a))
HPDI(logistic(post$a + post$b1 + post$b2 + post$bi) - logistic(post$a + post$b1))

HPDI(logistic(post$a + post$b1) - logistic(post$a ))